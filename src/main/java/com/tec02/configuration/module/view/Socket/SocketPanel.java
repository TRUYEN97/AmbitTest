 ...
 */
public class SocketPanel extends AbsModuleView<SocketDto> {
    ...
    public SocketPanel() {
        initComponents();
        this.hasTabPanel = new AbsHasTabPanel<SocketDto, ServerInfoPanel>() {
            @Override
            ...
            public void update() {
                ...
                for (ServerInfoPanel tab : getTabPanel().getTabElements().values()) {
                    tab.update();
